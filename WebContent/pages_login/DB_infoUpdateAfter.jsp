...
<%
	...
	try {
		...
		int result = stmt.executeUpdate("update customerinfo set customer_pwd='"+joinPwd+"', customer_email='"+emailId+"@"+emailAddr+"', customer_addr='"+firstAddr+" "+lastAddr+" "+extraAddr+"', customer_phone='"+firstPhone+"-"+middlePhone+"-"+lastPhone+"'");
		if(result > 0) {

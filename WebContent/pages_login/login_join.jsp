...
<body>
	...
	<section>
		<form name="join-form" method="post" action="./DB_joininsert.jsp">
			<!-- 이용약관 동의 폼 -->
			<div class="agreecheckContainer">
				<h1 class="titleText">이용약관 동의</h1>
				<div class="agreeContainer">
					<input type="checkbox" name="agree-check" value="이용약관">
					<h1>[필수] 이용약관 동의</h1>
					<div class="agreeArticle">
						<article>
							이용약관 내용 이용약관 내용 이용약관 내용 이용약관 내용 이용약관 내용 이용약관 내용 이용약관 내용 이용약관 내용 이용약관 내용 이용약관 내용 이용약관 내용 이용약관 내용 이용약관 내용 이용약관 내용 이용약관 내용 이용약관 내용 이용약관 내용 이용약관 내용 이용약관 내용 이용약관 내용 이용약관 내용 이용약관 내용 이용약관 내용 이용약관 내용 이용약관 내용 이용약관 내용 이용약관 내용 이용약관 내용 이용약관 내용 이용약관 내용 이용약관 내용 이용약관 내용 이용약관 내용 이용약관 내용 이용약관 내용 이용약관 내용 이용약관 내용 이용약관 내용 이용약관 내용 이용약관 내용 이용약관 내용 이용약관 내용 이용약관 내용 이용약관 내용 이용약관 내용 이용약관 내용 이용약관 내용 이용약관 내용 이용약관 내용 이용약관 내용 이용약관 내용 이용약관 내용 이용약관 내용 이용약관 내용 이용약관 내용 이용약관 내용 이용약관 내용 이용약관 내용 이용약관 내용 이용약관 내용 이용약관 내용 이용약관 내용 이용약관 내용 이용약관 내용 이용약관 내용 이용약관 내용 이용약관 내용 이용약관 내용 이용약관 내용 이용약관 내용
						</article>
					</div>
				</div>
			</div>
			...
			<div class="btnContainer">
				<input class="button textColor gray_4c4c4c" type="submit" name="submit" value="가입하기" onclick="return submitClick()">
			</div>
		</form>
	</section>

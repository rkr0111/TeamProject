		...
		<div class="header-inner">
			...
			<nav>
				<ul class="mainmenu">
					...
					<li><a href="product_bedroom.jsp">BEDROOM</a></li>
					<li><a href="product_stand.jsp">STAND</a></li>
					<li><a href="product_point.jsp">POINT</a></li>
			...
			<ul class="minimenu">
				...
				<li><a href="../TeamPro/pages_login/login_mypage.jsp">MY PAGE</a></li>
